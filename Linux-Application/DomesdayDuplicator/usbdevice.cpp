...
void UsbDevice::startCapture(QString filename, bool isCaptureFormat10Bit, bool isCaptureFormat10BitDecimated, bool isTestMode, bool stopOnDroppedSamples)
{
    ...
    if (result) {
        ...
        usbCapture = new UsbCapture(this, libUsbContext, usbDeviceHandle, filename,
                                    isCaptureFormat10Bit, isCaptureFormat10BitDecimated, isTestMode, stopOnDroppedSamples);
